 ...
 */
public class Poc2_DataObject {

    private final Firestore db;

    Poc2_DataObject(Firestore db) {
        this.db = db;
    }
...
//        System.out.println("Update time : " + result.get().getUpdateTime());
    ...
    public static void main(String[] args) throws Exception {
        ...
        Poc2_DataObject poc = new Poc2_DataObject(db);
//        poc.addSimpleDocumentAsEntity();
        poc.addDocumentWithDifferentDataTypes();
        poc.close();
    }
}